...
export interface Annotation { id?: number; bookId: string; cfi: string; quote: string; content: string; kind: 'note' | 'ai'; demo?: boolean; chapter?: string; createdAt: number; responseType?:string; isSpeculation?:boolean; relatedQuote?:string; }
